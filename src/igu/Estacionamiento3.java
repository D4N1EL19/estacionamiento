...
public class Estacionamiento3 extends javax.swing.JFrame {
    ...
    public Estacionamiento3(BaseDeDatos bd, int num, char tipo) {
        initComponents();
        this.bd = bd;
        this.nA = num;
        this.tipo = tipo;
        txtEspacios.setText(bd.getContEsta3() + " de 100 espacios disponibles");
    }
    ...
    private void initComponents() {
        ...
        lblEst1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
    ...
    private void lblEntrarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEntrarMousePressed
        ...
        bd.setContEsta1(bd.getContEsta3() + 1);
