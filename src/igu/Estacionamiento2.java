...
public class Estacionamiento2 extends javax.swing.JFrame {
    ...
    public Estacionamiento2(BaseDeDatos bd, int num, char tipo) {
        initComponents();
        this.bd = bd;
        this.nA = num;
        this.tipo = tipo;
        txtEspacios.setText(bd.getContEsta2() + " de 80 espacios disponibles");
    }
    ...
    private void initComponents() {
        ...
        lblCapacidad.setFont(new java.awt.Font("Montserrat", 0, 36)); // NOI18N
        ...
        lblEst1.setText("Estacionamiento 2");
    ...
    private void lblEntrarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEntrarMousePressed
        ...
        bd.setContEsta1(bd.getContEsta2() + 1);
